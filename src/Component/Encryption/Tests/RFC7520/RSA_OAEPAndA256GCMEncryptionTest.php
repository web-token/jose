 ...
 * @group RFC7520
 */
final class RSA_OAEPAndA256GCMEncryptionTest extends AbstractEncryptionTest
{
    /**
     * Please note that we cannot the encryption and get the same result as the example (IV, TAG and other data are always different).
     * The output given in the RFC is used and only decrypted.
     */
    public function testRSA_OAEPAndA256GCMEncryption()
    {
        ...
        $jweLoader = $this->getJWELoaderFactory()->create(['RSA-OAEP'], ['A256GCM'], ['DEF'], [], ['jwe_compact', 'jwe_json_flattened', 'jwe_json_general']);
