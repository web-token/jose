...
final class NestingTest extends AbstractEncryptionTest
{
    public function testDecryption()
    {
        ...
        $jweLoader = $this->getJWELoaderFactory()->create(['RSA-OAEP'], ['A128GCM'], ['DEF'], []);
        ...
        $loaded_compact_json = $jweLoader->decryptUsingKey($loaded_compact_json, $encryption_key, $index);
        $loaded_flattened_json = $jweLoader->decryptUsingKey($loaded_flattened_json, $encryption_key, $index);
        $loaded_json = $jweLoader->decryptUsingKey($loaded_json, $encryption_key, $index);
