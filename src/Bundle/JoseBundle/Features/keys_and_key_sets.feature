Feature: This bundle is able to use keys and key sets
  ...
  Scenario: A Key Set is available through a service
    When the service "jose.key_set.jwkset1" should be an object that implements "\Jose\Component\Core\JWKSet"
  ...
  Scenario: A Key Set is available through a service and loaded from an URL
    When the service "jose.key_set.jwkset2" should be an object that implements "\Jose\Component\Core\JWKSet"
    And the keyset in the service "jose.key_set.jwkset2" contains 4 keys

  Scenario: A Key Set is available through a service and loaded from an URL
    When the service "jose.key_set.jwkset3" should be an object that implements "\Jose\Component\Core\JWKSet"
    And the keyset in the service "jose.key_set.jwkset3" contains keys

  Scenario: A Key Set is available through a service and loaded from an URL
    When the service "jose.key_set.jwkset4" should be an object that implements "\Jose\Component\Core\JWKSet"
  ...
  Scenario: A Rotatable Key Set contains the expected number of keys
    ...
    When the service "jose.key_set.auto_signature" should be an object that implements "\Jose\Component\Core\JWKSet"
  ...
  Scenario: A Key Set of Key Sets contains the expected number of keys
    When the service "jose.key_set.all_in_one" should be an object that implements "\Jose\Component\KeyManagement\JWKSets"
    When the service "jose.key_set.all_in_one" should be an object that implements "\Jose\Component\Core\JWKSet"
  ...
  Scenario: A Public Key Set contains the expected number of keys
    ...
    When the service "jose.key_set.all_in_one_public" should be an object that implements "\Jose\Component\Core\JWKSet"
